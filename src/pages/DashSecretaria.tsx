...
export default function DashSecretaria() {
  ...
  return (
    <div className="bg-[#f0f0f5] min-h-screen p-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        ...
        <div className="lg:col-span-3 flex flex-col items-center">
          <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-xs">
            <h3 className="text-lg font-bold text-[#9588d0] mb-4">
              Citas para Ahora
            </h3>
      ...
      <AgregarPaciente
        isOpen={showAgregarPacienteModal}
        onClose={() => setShowAgregarPacienteModal(false)}
      />
      <AgregarCita
        isOpen={showAgregarCitaModal}
        onClose={() => setShowAgregarCitaModal(false)}
      />
    </div>
  );
}
