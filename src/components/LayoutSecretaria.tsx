    ...
    <div className="min-h-screen bg-[#f0f0f0]">
      <div className="bg-[#9588d0] p-4 text-white flex items-center justify-between">
        ...
        <nav className="space-x-6 text-xl">
          <Link to="/Secretaria/dashboard" className="hover:underline">
            Dashboard
          </Link>
          <Link to="/Secretaria/Pacientes" className="hover:underline">
            Pacientes
          </Link>
          <Link to="/Secretaria/Citas" className="hover:underline">
            Citas
          </Link>
        </nav>
      </div>
